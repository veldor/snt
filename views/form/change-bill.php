...
$form = ActiveForm::begin(['id' => 'changeBill', 'options' => ['class' => 'form-horizontal bg-default'], 'enableAjaxValidation' => false, 'validateOnSubmit' => false, 'action' => ['/form/bill-change/'. $matrix->id]]);
...
echo $form->field($matrix, 'payerId', ['template' =>
